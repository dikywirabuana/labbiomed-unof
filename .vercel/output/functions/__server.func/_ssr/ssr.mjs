...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C_ycAgSd.mjs");
...
var manifest = {
	"609ba6809a128126dca84a4c1fc1c5195d5fa574a3d0c45dc15957c55ca97c08": {
		functionName: "readLabHasil_createServerFn_handler",
		importer: () => import("./hasil-fn-B12LFmmo.mjs")
	},
	"e30b28a5373e1c69be24745a4d322d0db6d63bbc69f2974e07662b20606acebe": {
		functionName: "publishLabHasil_createServerFn_handler",
		importer: () => import("./hasil-fn-B12LFmmo.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D0DoDx79.mjs").then((n) => n.t),
